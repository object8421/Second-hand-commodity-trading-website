...
<div align=left>
<%
	String[] delID = request.getParameterValues("selDiscussion");
	String strID = "0";
	if (delID!=null)
	{
	...
	String strSql = "delete from discussion where ID in ("+strID+")";
	if(executeWay.exeSqlUpdate(strSql))
	{
		%>
			<center><font color=blue size=5>删除成功！</font></center><br><br>
			<center><input type=button name=gofirst value=确定 onclick=javascript:window.location='myDiscussionList.jsp' ></center>
		<%
	}
	else
	{		
