...
<%
	...
	goods.goodsField = Long.parseLong(myUpload.getFormFields("goodsField"));
	...
	if(goods.modifyGoodsInfo(strID))
	{
		...
		out.println("<center><input type=button name=gofirst value=确定 onclick=javascript:window.location='allGoodsList.jsp' ></center>");
