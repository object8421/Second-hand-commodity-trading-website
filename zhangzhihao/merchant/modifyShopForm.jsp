...
<FORM name=form1 onReset="return confirm('确定要清空当前表单吗？');" action=modifyShopSave.jsp         method=post target=_self>
		<table width="70%">
		  ...
		  <TD width="20%" align=right vAlign=top>主营项目：</TD>
            ...
            <TR > 
              ...
              <TD align=left><INPUT style="WIDTH: 230px; BACKGROUND-COLOR: white" 
            maxLength=100 name=shopName value=<%=codeToString(user.shopName)%>> </TD>
            </TR>
            <TR > 
            ...
            <TR > 
              ...
              <TD align=left><INPUT style="WIDTH: 230px; BACKGROUND-COLOR: white" 
            maxLength=100 name=shopper value=<%=codeToString(user.shopper)%>></TD>
            </TR>
            <TR > 
          ...
          align=left><TEXTAREA name=shopIntro rows=8 cols=50><%=codeToString(user.shopIntro)%></TEXTAREA></TD>
            ...
            <TR > 
              ...
              <TD align=left><INPUT maxLength=50 name=realName value=<%=codeToString(user.realName)%> readonly=true></TD>
            </TR>
			<TR> 
            ...
            <TR > 
              ...
              <TD align=left><INPUT maxLength=50 name=identityID value=<%=user.identityID%> readonly=true> <FONT 
