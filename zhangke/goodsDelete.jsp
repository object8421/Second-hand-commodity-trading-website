...
<%
	...
	if (deleteID!=null)
	{
		...
		{
			isDelete = goods.delete(deleteID[i]);
			if(!isDelete)
			break;
		}		
	}
	if(isDelete)
	{
		%>
			...
			<center><input type=button name=gofirst value=确定 onclick=javascript:window.location='allGoodsList.jsp?page=<%=strPage%>' ></center>
		<%
	}
	else
	{		
